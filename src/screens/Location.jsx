                        ...
                        {locationList &&
                            ...
                            locationList.results.map((location, index) => (
                                <tr key={index}>
                                    ...
                                    <td className="py-3 px-4 border-b text-center border-gray-300 hover:text-amber-500 transition-all duration-200 cursor-pointer" onClick={() => goToDetail(location.url)}>
                                        {location.url}
                                    </td>
                                </tr>
                            ))}
